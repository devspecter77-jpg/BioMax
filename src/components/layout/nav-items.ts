...
import {
  ...
  ShoppingBag, Building, Gift, ArrowRightLeft, MapPin, Truck, Wallet, ClipboardList, UsersRound, Boxes, Globe, LayoutGrid, ShieldCheck,
} from 'lucide-react'
...
const HAMMA = ['ADMIN', 'KASSIR', 'OMBORCHI', 'SOTUVCHI']
...
export const mobilePriorityOrder = [
  '/', '/sotuv', '/onlayn-buyurtmalar', '/nasiyalar', '/tovarlar', '/ombor', '/mijozlar',
...
export function visibleNavItems(rol: string | undefined, ruxsatlar?: string[] | null, filialId?: string | null, ulashilganEgaId?: string | null): NavItem[] {
  ...
  return navItems.filter((item) => {
    ...
    if ((item.href === '/onlayn-buyurtmalar' || item.href === '/onlayn-vitrina') && filialId) return false
